 ...
 *
 * @uses tinfoilcat_header_style()
 */
function tinfoilcat_custom_header_setup() {
...
if ( ! function_exists( 'tinfoilcat_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see tinfoilcat_custom_header_setup().
 */
function tinfoilcat_header_style() {
